...
export default function SpendingPieChart({ data }) {
  // Total calculate karne ka logic (dynamic banane ke liye)
    ...
    <div className="bg-white p-6 rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-50 flex flex-col h-full">
      ...
      <div className="relative flex-grow min-h-[250px]">
        <ResponsiveContainer width="100%" height="100%">
          <PieChart>
            <Tooltip
              // Indian Currency format in Tooltip
        ...
        {/* Center Label: Ab Indian Rupee symbol aur formatting ke saath */}
        ...
        {data.slice(0, 4).map((entry, index) => (
          <div key={entry.category} className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              />
              <span className="text-xs text-gray-500 truncate w-20">{entry.category}</span>
            </div>
